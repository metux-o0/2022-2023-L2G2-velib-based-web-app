...
const fuseauHoraire = 'https://velib-metropole-opendata.smoove.pro/opendata/Velib_Metropole/system_information.json';
const fluxExistants = 'https://velib-metropole-opendata.smoove.pro/opendata/Velib_Metropole/gbfs.json';
const veloBornetteDispo = 'https://velib-metropole-opendata.smoove.pro/opendata/Velib_Metropole/station_status.json'
const stationLocalisation = 'https://velib-metropole-opendata.smoove.pro/opendata/Velib_Metropole/station_information.json';
...
app.get('/fuseau', getFuseau, (req, res) => {
    console.log(req.fuseau);
    res.status(200).json(req.fuseau);
});
